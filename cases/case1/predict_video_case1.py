"""
Generate case1 real-time AMF-BiGRU prediction video.
"""
...
def generate_video():
    ...
    fig.suptitle("AMF-BiGRU Real-Time Moving Load Prediction (case1)", fontsize=17, fontweight="bold", color="white", y=0.96)
    ...
    ts_titles = ["Front Axle Weight", "Rear Axle Weight", "Front Wheel Position", "Rear Wheel Position"]
    ...
    for ax, title, ylabel, yt, yp in zip(ts_axes, ts_titles, ts_ylabels, ts_true, ts_pred):
